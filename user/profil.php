    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="infos_profil">
                ...
                <button class="btn" data-toggle="modal" data-target="#deleteCompte">Supprimer mon compte</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="updateEmail" class="btn btn-primary">Valider</button>
        </form>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="updateMdp" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <input type="hidden" name="idmembre" value="<?= $Membre['id_membre']?>">
        <button type="submit" name="updateMdp" class="btn btn-primary">Valider</button>
        </form>
      </div>
    </div>
  </div>
